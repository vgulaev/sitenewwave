...
(function() {
  var apply_rezka, create_rezka, delete_rezka_item, delete_rezka_part, fill_rezka, length_input_change,
  ...
  create_rezka = function() {
    var item, new_tbody_string, new_tr, slice_table, _i, _len, _ref, _ref1;
    new_tbody_string = "";
  ...
  fill_rezka = function(itid) {
    var M_count, M_len, item, rezka_array, _i, _item, _len, _ref;
    _ref = App.MyBasket._item_list;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      _item = _ref[_i];
      if (_item.id = itid) {
    ...
    return $.ajax({
      ...
      success: function(html) {
        ...
        return $("div[rid='" + item.id + "']").find(".rezka_leftovers").html(leftovers);
      }
    });
  };
